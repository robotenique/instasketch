...
$(function () {
    ...
    $("#submitAccept").on("click", function () {
        const newSketch = {
            ...
            session_id : activeSession != undefined ? activeSession.id : "-1", // -1 implies no session!!
            student_id : currentStudent.id,
            id : "11123" // This should be generated by the database in the server!
        }
        console.log('newSketch', newSketch);
